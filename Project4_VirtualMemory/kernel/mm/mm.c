...
uintptr_t alloc_page_helper(uintptr_t va, uintptr_t pgdir,pcb_t *pcbptr)
{
    ...
    //需要置起的flag位
    ptr_t bit_21 = _PAGE_PRESENT | _PAGE_USER | _PAGE_GLOBAL;
    ptr_t bit_0  = _PAGE_PRESENT |_PAGE_USER | _PAGE_READ |_PAGE_GLOBAL | _PAGE_WRITE | _PAGE_EXEC | _PAGE_ACCESSED | _PAGE_DIRTY;
    //L2 中的页表项
